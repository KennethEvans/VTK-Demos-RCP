...
public class AreaDetector2Demo extends VTKDemo
{
  ...
  private static final double AXES_SIZE = .6 * PLANE_SIZE;
  ...
  public AreaDetector2Demo() {
    super();
    setName("Area Detector 2");
  }
...
//    cPlane1Axes = new Axes2(AXES_SIZE, "XC", "YC", "ZC", RED, GREEN, BLUE);
    cPlane1Axes = new Axes2(AXES_SIZE, "XC", "YC", "ZC", cPlaneColors,
...
//    dPlane1Axes = new Axes2(AXES_SIZE, "XD", "YD", "ZD", RED, GREEN, BLUE);
    dPlane1Axes = new Axes2(AXES_SIZE, "XD", "YD", "ZD", dPlaneColors,
